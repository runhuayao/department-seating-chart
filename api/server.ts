...
const corsOptions = {
  origin: process.env.NODE_ENV === 'production' 
    ...
    : ['http://localhost:5173', 'http://localhost:5174', 'http://localhost:3000', 'http://localhost:3001', 'http://127.0.0.1:5173', 'http://127.0.0.1:5174', 'http://127.0.0.1:3001'], // 开发环境允许本地端口
