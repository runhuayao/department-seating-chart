...
-- 1. 插入部门数据
-- 基于M0版本的departmentConfigs数据，但跳过插入因为部门数据已存在
-- 注意：部门数据已在001_create_tables.sql中插入，这里不再重复插入
...
--  '{"gridSize": 20, "canvasWidth": 1200, "canvasHeight": 800, "showGrid": true, "snapToGrid": true}', 
--  '/images/departments/development.jpg', 'active'),
-- 
-- ('design', '设计部', '负责产品设计和用户体验', '#10B981', 
--  '{"gridSize": 20, "canvasWidth": 1000, "canvasHeight": 600, "showGrid": true, "snapToGrid": true}', 
--  '/images/departments/design.jpg', 'active'),
-- 
-- ('marketing', '市场部', '负责市场推广和品牌建设', '#F59E0B', 
--  '{"gridSize": 20, "canvasWidth": 800, "canvasHeight": 600, "showGrid": true, "snapToGrid": true}', 
--  '/images/departments/marketing.jpg', 'active'),
-- 
-- ('hr', '人事部', '负责人力资源管理和企业文化建设', '#EF4444', 
--  '{"gridSize": 20, "canvasWidth": 600, "canvasHeight": 400, "showGrid": true, "snapToGrid": true}', 
--  '/images/departments/hr.jpg', 'active')

-- 跳过部门数据插入，使用现有的中文部门数据
...
FROM (
    VALUES 
    -- 技术部工位
    ('A001', '技术部', 100, 100, 120, 80, false, '{"computer": "MacBook Pro", "monitor": "27inch 4K", "keyboard": "机械键盘", "mouse": "无线鼠标"}'),
    ('A002', '技术部', 250, 100, 120, 80, true, '{"computer": "ThinkPad X1", "monitor": "24inch FHD", "keyboard": "薄膜键盘", "mouse": "有线鼠标"}'),
    ('A003', '技术部', 400, 100, 120, 80, true, '{"computer": "MacBook Air", "monitor": "27inch 4K", "keyboard": "机械键盘", "mouse": "无线鼠标"}'),
    ('A004', '技术部', 550, 100, 120, 80, false, '{"computer": "iMac 27", "keyboard": "Magic Keyboard", "mouse": "Magic Mouse"}'),
    ('A005', '技术部', 100, 220, 120, 80, true, '{"computer": "Dell XPS", "monitor": "32inch 4K", "keyboard": "机械键盘", "mouse": "游戏鼠标"}'),
    ('A006', '技术部', 250, 220, 120, 80, false, '{"computer": "Surface Pro", "monitor": "24inch FHD", "keyboard": "无线键盘", "mouse": "无线鼠标"}'),
    
    -- 产品部工位
    ('B001', '产品部', 100, 100, 140, 90, true, '{"computer": "MacBook Pro 16", "monitor": "32inch 4K", "tablet": "iPad Pro", "stylus": "Apple Pencil"}'),
    ('B002', '产品部', 280, 100, 140, 90, true, '{"computer": "iMac 27", "monitor": "27inch 5K", "tablet": "Wacom Cintiq", "stylus": "Wacom Pen"}'),
    ('B003', '产品部', 460, 100, 140, 90, false, '{"computer": "Surface Studio", "tablet": "Surface Pen", "scanner": "A3扫描仪"}'),
    ('B004', '产品部', 100, 230, 140, 90, false, '{"computer": "MacBook Air", "monitor": "24inch 4K", "tablet": "iPad Air", "stylus": "Apple Pencil"}'),
    
    -- 运营部工位
    ('C001', '运营部', 100, 100, 110, 70, true, '{"computer": "ThinkPad T14", "monitor": "24inch FHD", "phone": "IP电话", "printer": "彩色打印机"}'),
    ('C002', '运营部', 240, 100, 110, 70, true, '{"computer": "MacBook Air", "monitor": "27inch 4K", "phone": "IP电话", "camera": "数码相机"}'),
    ('C003', '运营部', 380, 100, 110, 70, false, '{"computer": "Surface Laptop", "monitor": "24inch FHD", "phone": "IP电话", "projector": "便携投影仪"}'),
    
    -- 人事部工位
    ('D001', '人事部', 100, 100, 100, 70, true, '{"computer": "ThinkPad E14", "monitor": "22inch FHD", "phone": "IP电话", "printer": "黑白打印机"}'),
    ('D002', '人事部', 230, 100, 100, 70, false, '{"computer": "Dell Inspiron", "monitor": "24inch FHD", "phone": "IP电话", "scanner": "文档扫描仪"}')
...
ON CONFLICT (desk_number) DO UPDATE SET
