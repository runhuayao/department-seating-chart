...
│   │   ├── Dashboard.tsx       # 主仪表板
│   │   ├── Admin.tsx           # 管理后台
│   │   └── ServerManagementRoot.tsx # M1服务器管理根页面
│   ├── utils/                   # 工具函数
│   │   ├── api.ts              # API调用封装
│   │   └── helpers.ts          # 辅助函数
...
├── vite.config.ts              # 部门地图Vite配置
├── vite.server-management.config.ts # 服务器管理系统Vite配置
├── server-management.html      # 服务器管理系统HTML入口
├── tsconfig.json               # TypeScript配置
├── tailwind.config.js          # Tailwind CSS配置
├── CHANGELOG.md                # 版本更新日志
├── README.md                   # 项目说明文档
└── README-SERVER-MANAGEMENT.md # 服务器管理系统说明文档
```
...
# 构建服务器管理系统
npm run build:server-management
